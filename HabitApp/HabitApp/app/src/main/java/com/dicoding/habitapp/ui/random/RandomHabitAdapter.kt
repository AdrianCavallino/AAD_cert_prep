...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        var tvTitle: TextView = itemView.findViewById(R.id.pager_tv_title)
        var ivPriority: ImageView = itemView.findViewById(R.id.pager_item_priority_level)
        var tvMinutes: TextView = itemView.findViewById(R.id.pager_tv_minutes)
        var tvStartTime : TextView = itemView.findViewById(R.id.pager_tv_start_time)
        var btn: Button = itemView.findViewById(R.id.pager_btn_open_count_down)
